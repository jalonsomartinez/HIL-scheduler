...
- Keep dedicated twin-history files and shared historical plots aligned with the same summary contract, including voltage-bucket node counts.
...
4. Digital-twin summary metrics and voltage-bucket node counts remain consistent across twin-history files, historical plots, and Grid Map summary surfaces.
