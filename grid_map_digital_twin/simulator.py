...
def load_assets() -> Dict[str, Any]:
    """Return the cached asset bundle used by the simulator."""
    return _load_assets()


def get_base_network_copy() -> Any:
    """Return an isolated copy of the packaged pandapower network."""
    return copy.deepcopy(_load_assets()["base_net"])


def get_metadata() -> Dict[str, Any]:
    """Return package metadata as a shallow copy."""
    return dict(_load_assets()["metadata"])
