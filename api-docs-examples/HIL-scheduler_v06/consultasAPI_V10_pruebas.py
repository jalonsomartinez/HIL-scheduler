...
if __name__ == "__main__":
    ...
    lib_day_ahead_setpoints_kW, vrfb_day_ahead_setpoints_kW = api.day_ahead_schedule_between_periods(delivery_period_gte="2026-02-23T23:00:00+00:00", delivery_period_lte="2026-02-24T22:45:00+00:00")
    ...
    #######Uso para posteo de mediciones. Prueba de todas las funciones de posteo, con y sin timestamp (si no se especifica timestamp, se usará el actual en UTC).
    response_timestamp_1 = api.post_lib_SOC_kWh(0)
    print("Response for posting LIB SOC kWh:", response_timestamp_1)
    print()
    response_timestamp_2 = api.post_lib_P_W(0)
    print("Response for posting LIB P W:", response_timestamp_2)
    print()
    response_timestamp_3 = api.post_lib_Q_VAr(0)
    print("Response for posting LIB Q VAr:", response_timestamp_3)
    print()
    response_timestamp_4 = api.post_lib_V_V(0)
    print("Response for posting LIB V V:", response_timestamp_4)
    print()
    response_timestamp_5 = api.post_vrfb_SOC_kWh(0)
    print("Response for posting VRFB SOC kWh:", response_timestamp_5)
    print()
    response_timestamp_6 = api.post_vrfb_P_W(300.0)
    print("Response for posting VRFB P W:", response_timestamp_6)
    print()
    response_timestamp_7 = api.post_vrfb_Q_VAr(150.0)
    print("Response for posting VRFB Q VAr:", response_timestamp_7)
    print()
    response_timestamp_8 = api.post_vrfb_V_V(450.0)
    print("Response for posting VRFB V V:", response_timestamp_8)
