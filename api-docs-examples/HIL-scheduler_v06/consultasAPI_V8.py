...
if __name__ == "__main__":
    ...
    results_day_ahead_greater_than = api.day_ahead_greater_than(delivery_period_gte="2026-01-29 00:00:00")
    print(results_day_ahead_greater_than)

    # results_day_ahead_between_periods = api.day_ahead_between_periods(delivery_period_gte="2026-01-29 00:00:00", delivery_period_lte="2026-01-29 23:45:00")
    ...
    lib_day_ahead_setpoints_kW, vrfb_day_ahead_setpoints_kW = api.day_ahead_schedule_between_periods(delivery_period_gte="2026-01-30 00:00:00", delivery_period_lte="2026-01-30 23:45:00")
    ...
    # results_mfrr_greater_than = api.mfrr_greater_than(delivery_period_gte="2026-01-28 16:32:00")
